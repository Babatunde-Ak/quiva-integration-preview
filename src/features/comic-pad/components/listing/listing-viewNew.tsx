...
// import useComicPlatform from '@/hook/useMarketplace';
...
//     ) => {
//         try {
//             // New ethers/wagmi hook returns { txHash, status, tokenAddress }
//             // instead of the old { transactionId, tokenId, indexedVia }.
...
//                 throw new Error(
//                     "Transaction confirmed on-chain, but the new token address could not be " +
//                     "extracted from the Mirror Node event logs. Check HashScan for tx: " + result.txHash
//                 );
//             }

//             const collectionData = {
//                 // Downstream code (executeMintAndList, backend update) expects
//                 // tokenId — we carry the raw EVM token address here. If your
//                 // backend/HTS flow needs the Hedera-format token ID (0.0.X),
//                 // convert it from the EVM address before sending it on.
//                 tokenId: result.tokenAddress,
