          ...
          {/* Right side - Icons and Stats */}
            <div className="flex items-center gap-2 sm:gap-3 text-[10px] sm:text-xs text-white flex-shrink-0">
                ...
                <div className='flex flex-col items-center'>
                    ...
                    <div className="flex items-center gap-0.5 mt-0.5 bg-black-200 border border-black-50 px-1.5 py-0.5 rounded-md">
                        <span className="text-[9px] sm:text-[10px]">Listed</span>
                        <Check className="w-2 h-2 sm:w-3 sm:h-3 bg-green-500"/>
                    </div>
                </div>
